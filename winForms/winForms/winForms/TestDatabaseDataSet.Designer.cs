...
namespace winForms {
    ...
    public partial class TestDatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class TestTableDataTable : global::System.Data.TypedTableBase<TestTableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TestTableRow AddTestTableRow(string Name, string Surname, int Age) {
        ...
        public partial class TestTableRow : global::System.Data.DataRow {
            ...
            public string Surname {
                get {
                    return ((string)(this[this.tableTestTable.SurnameColumn]));
                }
                set {
                    this[this.tableTestTable.SurnameColumn] = value;
                }
            }
            ...
            public int Age {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Age\' в таблице \'TestTable\' равно DBNull.", e);
                    }
                }
                set {
...
namespace winForms.TestDatabaseDataSetTableAdapters {
    ...
    public partial class TestTableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[TestTable] WHERE (([ID] = @Original_ID) AND ([Name] = @Origina" +
                "l_Name) AND ([Surname] = @Original_Surname) AND ((@IsNull_Age = 1 AND [Age] IS N" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TestTable] ([Name], [Surname], [Age]) VALUES (@Name, @Surname," +
                " @Age);\r\nSELECT ID, Name, Surname, Age FROM TestTable WHERE (ID = SCOPE_IDENTITY" +
                "())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[TestTable] SET [Name] = @Name, [Surname] = @Surname, [Age] = @Age WHERE (([ID] = @Original_ID) AND ([Name] = @Original_Name) AND ([Surname] = @Original_Surname) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)));
SELECT ID, Name, Surname, Age FROM TestTable WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::winForms.Properties.Settings.Default.TestDatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Surname, Age FROM dbo.TestTable";
        ...
        public virtual int Fill(TestDatabaseDataSet.TestTableDataTable dataTable) {
        ...
        public virtual TestDatabaseDataSet.TestTableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            TestDatabaseDataSet.TestTableDataTable dataTable = new TestDatabaseDataSet.TestTableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(TestDatabaseDataSet.TestTableDataTable dataTable) {
